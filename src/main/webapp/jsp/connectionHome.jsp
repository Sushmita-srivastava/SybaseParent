					...
					<div class="card-body">
						...
						<div class="container">
								  <div class="row text-center text-lg-left">
								    ...
								    <div class="thumbnail col-lg-3 col-md-4 col-xs-6" onclick="pass('sybase');">
								      <a href="#" class="d-block mb-4 h-100">
								            <img class="img-fluid img-thumbnail" src="${pageContext.request.contextPath}/assets/img/sybase1.png">
								          </a>
								    </div>
